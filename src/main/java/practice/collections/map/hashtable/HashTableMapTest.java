...
public class HashTableMapTest {
     ...
     */
    protected Map<String, Employee> makeEmptyMap() {
        return new HashTableMap<String, Employee>();
    }
     ...
     */
    protected Map<String, Employee> makePopulatedMap() {
        return new HashTableMap<String, Employee>(){{
            for (int i = 0; i < 1_000; i++) {
                put(String.valueOf(i), new Employee(String.valueOf(i)));
            }
        }};
    }
     ...
     * that will not be found in the map.
     */
    protected Employee getValueNotInPopulatedMap() {
        return new Employee("notInMap");
    }
     ...
     */
    protected Map<String, Employee> makeEitherMap() {
        try {
    ...
    protected final boolean supportsValuesHashCode(Map<String, Employee> map) {
     ...
     */
    protected final void assertInvariants(Map<String, Employee> map) {
        Set<String> keySet = map.keySet();
        Collection<Employee> valueCollection = map.values();
        ...
        for (Employee value : valueCollection) {
            assertTrue(map.containsValue(value));
     ...
     */
    protected void assertMoreInvariants(Map<String, Employee> map) {
    }

    @Test  public void testClear() {
        final Map<String, Employee> map;
        try {
    ...
    @Test  public void testEntrySet() {
        final Map<String, Employee> map;
        final Set<Entry<String, Employee>> entrySet;
        try {
            map = makePopulatedMap();
        } catch (UnsupportedOperationException e) {
            return;
    ...
    @Test  public void testEntrySetContainsEntryNullKeyPresent() {
        ...
        Entry<String, Employee> entry = mapEntry(null, unmappedValue);
    ...
    @Test  public void testEntrySetSetValue() {
        ...
        Set<Entry<String, Employee>> entrySet = map.entrySet();
        Entry<String, Employee> entry = entrySet.iterator().next();
        final Employee oldValue = entry.getValue();
        final Employee returnedValue = entry.setValue(valueToSet);
    ...
    @Test  public void testEntrySetSetValueSameValue() {
        ...
        Entry<String, Employee> entry = entrySet.iterator().next();
        final Employee oldValue = entry.getValue();
        final Employee returnedValue = entry.setValue(oldValue);
        assertEquals(oldValue, returnedValue);
    ...
    @Test  public void testEqualsForLargerMap() {
        ...
        final Map<String, Employee> map;
        final Map<String, Employee> largerMap;
        try {
            map = makePopulatedMap();
    ...
    @Test  public void testEqualsForSmallerMap() {
        ...
        final Map<String, Employee> map;
        final Map<String, Employee> smallerMap;
        try {
            map = makePopulatedMap();
    ...
    @Test  public void testGetNull() {
        Map<String, Employee> map = makeEitherMap();
        if (allowsNullKeys) {
            if (allowsNullValues) {
    ...
    @Test  public void testPutNewKey() {
        final Map<String, Employee> map = makeEitherMap();
        final String keyToPut;
        final Employee valueToPut;
        try {
        ...
        if (supportsPut) {
            int initialSize = map.size();
            Employee oldValue = map.put(keyToPut, valueToPut);
    ...
    @Test  public void testPutAllNewKey() {
        ...
        final Map<String, Employee> mapToPut = Collections.singletonMap(keyToPut, valueToPut);
        if (supportsPut) {
            int initialSize = map.size();
            map.putAll(mapToPut);
            assertEquals(valueToPut, map.get(keyToPut));
    ...
    @Test  public void testRemove() {
        ...
        if (supportsRemove) {
            int initialSize = map.size();
            Employee expectedValue = map.get(keyToRemove);
            Employee oldValue = map.remove(keyToRemove);
    ...
    @Test  public void testValues() {
        final Map<String, Employee> map;
        final Collection<Employee> valueCollection;
        try {
            map = makePopulatedMap();
        } catch (UnsupportedOperationException e) {
            return;
